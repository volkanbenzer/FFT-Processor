...
HD_PWD='D:/Projects/Verilog/FFT_Processor_V1.3/FFT_Processor_V1.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Processor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_Processor_top.tcl
